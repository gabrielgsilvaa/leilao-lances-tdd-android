...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        carro.propoe(new Lance(new Usuario("Fran"), 1000.00));
        carro.propoe(new Lance(new Usuario("Alex"), 2000.00));

        Leilao computador = new Leilao("Computador");
        computador.propoe(new Lance(new Usuario("Fran"), 500.00));
        computador.propoe(new Lance(new Usuario("Alex"), 300.00));
